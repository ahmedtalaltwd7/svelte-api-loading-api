...
<div>
  ...
  lodind
   ...
   <div class="py-2 grid gap-4 md:grid-cols-2 grid-cols-1">
       {#each user as user}
       <a  class="list-none p-6 bg-gray-100 text-gray-800 text-center rounded-md shadow-sm hover:shadow-md flex flex-col items-center" href={`/ro/${user.id}`} transition:fly>
